    ...
    pub async fn send_prompt(
        ...
        loop {
            ...
            for tool_call in &tool_calls {
                ...
                // A tool can return structured JSON. Parse it when we can, so the
                // model receives real fields (numbers, arrays, objects) rather
                // than one great big escaped string.
